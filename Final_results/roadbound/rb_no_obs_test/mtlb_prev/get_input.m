%Input values 
function [w_guess,v_guess,delt,x_points_left,y_points_left,x_points_right,y_points_right,wp,n_w,n_ob,v_obx,v_oby,r_ob,n,avg_speed,oth] = get_input(x0,y0,firstval,secondval)
n=50;
...
% end
n_w=wp(:,3);
r_ob=[0.5,0.5,0.5,0.9];
oth = [0,0,0,0];
n_ob=1000;
v_obx=[0.2,0.3,0.5,0.2];
v_oby=[0,0,0,0];
