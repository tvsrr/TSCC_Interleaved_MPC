...
tic
[w_guess,v_guess,delt,x_points_left,y_points_left,x_points_right,y_points_right,wp,n_w,n_ob,v_movx,v_movy,r_ob,n,avg_speed,oth] = get_input(x0,y0,firstval,secondval);
mred=0;
x_in=x0;obinx = x_ob;
y_in=y0;obiny = y_ob;
thet = theta_in;
...
if (x_in==firstval & y_in == secondval)
-0.05<= w_cvx(1)<=0.05;
-0.05<= w_cvx(n)<=0.05;
end
