function [vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob,wp]=launch_iros(x0,y0,x_ob,y_ob,theta_in,na,mela,ob)
...
if (abs(preval-cvx_optval)<=0.005 )  %tolerance corection 
    ct=0;
else
   ct=ct+1;
end
