function [vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob]=launch_iros(x0,y0,x_ob,y_ob,theta_in,na,mela,ob,v,w)
...
theta_in=double(theta_in);na = double(na); mela = double(mela); v= double(v);w=double(w);

tic
[w_guess,v_guess,delt,x_points_left,y_points_left,x_points_right,y_points_right,wp,n_w,n_ob,v_movx,v_movy,r_ob,n,avg_speed,oth] = get_input(x0,y0,firstval,v,w);
mred=0;
x_in=x0;obinx = x_ob;
y_in=y0;obiny = y_ob;
thet = theta_in;
