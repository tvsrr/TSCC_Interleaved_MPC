function [vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob]=launch_iros(x0,y0,x_ob,y_ob,theta_in,na,mela,ob,vipas,wipas)
...
-2.2*delt <= vel(2:n) - vel(1:(n-1))<= 4*delt;
if (x_in==firstval)
-0.05<= w_cvx(1)<=0.05;
%-0.05<= w_cvx(n)<=0.05;
end
