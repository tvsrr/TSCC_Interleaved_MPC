    %plotting 
function [x1,y1,xob,yob,yaw]=plot_karo(x0,y0,x_in,y_in,v_guess,w_guess,theta_in,delt,x_points_left,y_points_left,x_points_right,y_points_right,wp,red,n,lo,x_ob,y_ob,r_ob,roadx,roady,road_bound,obavoid,n_ob,v_movx,v_movy,obroadx,obroady)
init=theta_in;
