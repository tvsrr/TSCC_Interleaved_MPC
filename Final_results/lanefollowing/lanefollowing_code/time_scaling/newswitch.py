...
def mpccaller(x0,y0,xob,yob,th,na,mela,ob,v,w):
	#"-nojvm -nodisplay -nosplash"
	eng = matlab.engine.start_matlab("-nojvm -nodisplay -nosplash")
	eng.addpath(r'/home/raghu/Desktop/Iv_2019/lane_following/mtlb')
	vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob,x1,y1=eng.launch_iros(float(x0),float(y0),matlab.double(xob),matlab.double(yob),float(th),na,mela,ob,v,w, nargout=12)
	eng.quit()
	x_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/x_points_right.csv')
	x_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/x_points_left.csv')
	y_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/y_points_right.csv')
	y_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/y_points_left.csv')
	x_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/x_points_midleft.csv')
	y_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/lane_following/time_scaling/y_points_midleft.csv')
	...
	return vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,x_points_midleft,y_points_midleft,cumx,cumy
...
def tscc(stateRobo,stateObst,vl,wl,x_points_right,y_points_right,x_points_left,y_points_left,v_movx,v_movy,oth,r_ob):
	...
	return velocity,omega,deltT,stateRobo,stateObst,cumxp,cumyp,cumxob,cumyob,cum_vel,cum_om,yaw,cumscale
...
def plotter(prex,prey,prox,proy,cum_vel,cum_om,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,rob,thl,yaw,x_points_midleft,y_points_midleft,cumx,cumy):
    fig2=plt.figure()
    yaw=yaw*180/3.14
...
vlast,wlast,vgot,wgot,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,x_points_midleft,y_points_midleft,cumx,cumy=mpccaller(109,210,[120,130,100,111,150],[210,210,213,213,213],0,10,1,1,v,w)
...
while(simulationtime):
	...
	velocity,omega,deltT,stateRobo,stateObst,cumxp,cumyp,cumxob,cumyob,cum_vel,cum_om,yaw,cumscale=tscc(stateRobo,stateObst,vgot,wgot,x_points_right,y_points_right,x_points_left,y_points_left,v_movx,v_movy,oth,r_ob)
	finalscale.append(cumscale)
	...
	plotter(prex,prey,prox,proy,finalvel,finalom,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,r_ob,thl,cumyaw,x_points_midleft,y_points_midleft,cumx,cumy)

	v= stateRobo[3]
	w= stateRobo[4]
	vlast,wlast,vgot,wgot,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,x_points_midleft,y_points_midleft,cumx,cumy=mpccaller(xl,yl,xob,yob,thl,10,1,1,float(v),float(w))
	simulationtime-=1
