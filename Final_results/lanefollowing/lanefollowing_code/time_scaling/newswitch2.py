...
def mpccaller(x0,y0,xob,yob,th,na,mela,ob):
	...
	eng.addpath(r'/home/raghu/Desktop/Iv_2019/results/mtlb')
	vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob,x1,y1=eng.launch_iros(float(x0),float(y0),matlab.double(xob),matlab.double(yob),float(th),na,mela,ob, nargout=12)
	eng.quit()
	x_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/x_points_right.csv')
	x_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/x_points_left.csv')
	y_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/y_points_right.csv')
	y_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/y_points_left.csv')
	x_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/x_points_midleft.csv')
	y_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/results/time_scaling/y_points_midleft.csv')
...
vlast,wlast,vgot,wgot,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,x_points_midleft,y_points_midleft,cumx,cumy=mpccaller(109,210,[150],[213],0,10,1,1)
...
while(simulationtime):
	...
	vlast,wlast,vgot,wgot,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,x_points_midleft,y_points_midleft,cumx,cumy=mpccaller(xl,yl,xob,yob,thl,10,1,1)
	simulationtime-=1
