function [vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob,x1,y1]=launch_iros(x0,y0,x_ob,y_ob,theta_in,na,mela,ob,v,w)
...
ful= sum(fin)+0.1*(sum(slack1.^2)+sum(slack2.^2))+cont1^2+cont2^2;
minimize(ful) 
subject to 
if (road_bound~=0)
lsum==0;
