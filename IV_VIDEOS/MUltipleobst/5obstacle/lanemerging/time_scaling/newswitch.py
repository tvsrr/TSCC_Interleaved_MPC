...
def mpccaller(x0,y0,xob,yob,th,na,mela,ob,vipas,wipas,mpv,mpw):
	...
	eng.addpath(r'/home/raghu/Desktop/Iv_2019/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/mtlb')
	...
	eng.quit()
	x_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/x_points_right.csv')
	x_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/x_points_left.csv')
	y_points_right=np.genfromtxt('/home/raghu/Desktop/Iv_2019/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/y_points_right.csv')
	y_points_left=np.genfromtxt('/home/raghu/Desktop/Iv_2019/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/y_points_left.csv')
	# x_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/Results_videos/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/x_points_midleft.csv')
	# y_points_midleft=np.genfromtxt('/home/raghu/Desktop/Iv_2019/Results_videos/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/y_points_midleft.csv')
...
def plotter(prex,prey,prox,proy,cum_vel,cum_om,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,rob,thl,yaw,mpv,mpw):
    ...
    with writer.saving(fig2, "writer_test.mp4", 100):
	    for i in range(len(prex)):
	    	...
	    	# xlmark = np.genfromtxt('/home/raghu/Desktop/Iv_2019/Results_videos/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/xlmark.csv')
	    	# ylmark = np.genfromtxt('/home/raghu/Desktop/Iv_2019/Results_videos/IV_VIDEOS/MUltipleobst/5obstacle/lanemerging/time_scaling/ylmark.csv')
	    	

	    	# plt.plot(xlmark+6,ylmark+3,linestyle='--',color='black')
	    	plt.plot(x_points_right,y_points_right+2,linestyle='--',color='black',linewidth=0.25)
	    	
	    	plt.fill_between(x_points_left,1000,y_points_left+3,facecolor=(0.8,0.8,0.8))
	    	plt.plot((x_points_left+x_points_right)/2 ,(y_points_left+y_points_right+5)/2 ,linestyle='--',color='black',linewidth=0.25)
	    	# plt.plot(x_points_left[:27],y_new_left,marker='*',color='blue',)
	    	plt.plot(x_points_left,y_points_left+3,linestyle='solid',color='black')


	    	x_points_exright = x_points_right
	    	y_points_exright = y_points_right-5
	    	plt.fill_between(x_points_exright,-1000,y_points_exright,facecolor=(0.8,0.8,0.8))

	    	plt.plot(x_points_exright,y_points_exright,linestyle='solid',color='black')
	    	plt.plot(prex,prey,label='robot',linestyle='--',color='blue',linewidth=2)
...
mpw =np.array([])
vipas=0.01;wipas=0
vlast,wlast,vgot,wgot,v_movx,v_movy,stateRobo,stateObst,x_points_right,y_points_right,x_points_left,y_points_left,oth,r_ob,mpv,mpw=mpccaller(0,0,[15,30,45,-15,5,75],[-1,8,-1,8,-8,8],0,10,1,1,vipas,wipas,mpv,mpw)
...
while(simulationtime):
	# if stateRobo[0]==0:
	# 	stateObst.append([25,12,1.57,-0.5])
	# 	stateObst.append([25,-4,1.57,0.5])
