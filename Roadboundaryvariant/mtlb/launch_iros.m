function [vlast,wlast,vsend,wsend,v_movx,v_movy,stateRobo,stateObst,oth,r_ob]=launch_iros(x0,y0,x_ob,y_ob,theta_in,na,mela,ob,vpa,wpa)
...
stateRobo=[x_in,y_in,thet,vpa,wpa];
